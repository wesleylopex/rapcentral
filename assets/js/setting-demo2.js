...
var imagePick = base_url + 'assets/img/sidebar-images/1.jpg';
...
function customCheckColor() {
    ...
    if (typeof sidebar == typeof undefined) {
        if (typeof logoHeader !== typeof undefined) {
            $('.logo-header .logo-img').attr('src', base_url + 'assets/img/logoresponsive2.png');
            $('.logo-header .navbar-brand').attr('src', base_url + 'assets/img/logo_jocc_branco.png');
        } else {
            $('.logo-header .logo-img').attr('src', base_url + 'assets/img/logoresponsive.png');
            $('.logo-header .navbar-brand').attr('src', base_url + 'assets/img/logoheader.png');
        }
    } else {
        if ($(window).width() > 991) {
            $('.logo-header .logo-img').attr('src', base_url + 'assets/img/logoresponsive2.png');
