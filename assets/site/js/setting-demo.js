...
var imagePick = base_url + 'assets/painel/img/sidebar-images/1.jpg';
...
function customCheckColor() {
    ...
    if (typeof sidebar == typeof undefined) {
        if (typeof logoHeader !== typeof undefined) {
            $('.logo-header .logo-img').attr('src', base_url + 'assets/painel/img/logoresponsive2.png');
            $('.logo-header .navbar-brand').attr('src', base_url + 'assets/painel/img/logo_jocc_branco.png');
        } else {
            $('.logo-header .logo-img').attr('src', base_url + 'assets/painel/img/logoresponsive.png');
            $('.logo-header .navbar-brand').attr('src', base_url + 'assets/painel/img/logoheader.png');
        }
    } else {
        if ($(window).width() > 991) {
            $('.logo-header .logo-img').attr('src', base_url + 'assets/painel/img/logoresponsive2.png');
