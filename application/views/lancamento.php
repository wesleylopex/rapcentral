                ...
                <div class="row">
                    <main class="col-md-9 col-sm-12 col-xs-12 right-sidebar sm-margin-60px-bottom xs-margin-40px-bottom no-padding-left sm-no-padding-right">
                        <div class="col-md-12 col-sm-12 col-xs-12 blog-details-text last-paragraph-no-margin">
                            <img src="http://placehold.it/900x631" alt="" class="width-100 margin-45px-bottom">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 text-right sm-text-center">
                            <div class="social-icon-style-6">
                                <ul class="extra-small-icon">
                                    <li><a class="likes-count"><i class="fa fa-heart text-deep-pink"></i><span class="text-small">Compartilhe</span></a></li>
                    ...
                    <aside class="col-md-3 pull-right">
                        ...
                        <div class="margin-45px-bottom xs-margin-25px-bottom">
                            ...
                            <ul class="latest-post position-relative">
                                <li>
                                    <figure>
                                        <a href="javascript:void(0);"><img src="http://placehold.it/480x358" alt=""></a>
                                    </figure>
                                    <div class="display-table-cell vertical-align-top text-small"><a href="javascript:void(0);" class="text-extra-dark-gray"><span class="display-inline-block margin-5px-bottom">Traveling abroad will change you forever</span></a> <span class="clearfix text-medium-gray text-small">April 30, 2016</span></div>
                                </li>
                                <li>
                                    <figure>
                                        <a href="javascript:void(0);"><img src="http://placehold.it/480x358" alt=""></a>
                                    </figure>
                                    <div class="display-table-cell vertical-align-top text-small"><a href="javascript:void(0);" class="text-extra-dark-gray"><span class="display-inline-block margin-5px-bottom">Having a new perspec-tive on new york city</span></a> <span class="clearfix text-medium-gray text-small">March 10, 2016</span></div>
                                </li>
                                <li>
                                    <figure>
                                        <a href="javascript:void(0);"><img src="http://placehold.it/480x358" alt=""></a>
                                    </figure>
                                    <div class="display-table-cell vertical-align-top text-small"><a href="javascript:void(0);" class="text-extra-dark-gray"><span class="display-inline-block margin-5px-bottom">The incredible talents of street performers</span></a> <span class="clearfix text-medium-gray text-small">March 05, 2016</span></div>
                                </li>
                                <li>
                                    <figure>
                                        <a href="javascript:void(0);"><img src="http://placehold.it/480x358" alt=""></a>
                                    </figure>
                                    <div class="display-table-cell vertical-align-top text-small"><a href="javascript:void(0);" class="text-extra-dark-gray"><span class="display-inline-block margin-5px-bottom">Praesent placerat risus quis eros</span></a> <span class="clearfix text-medium-gray text-small">March  01, 2016</span></div>
                                </li>
                            </ul>
                        </div>
                        <div class="margin-45px-bottom xs-margin-25px-bottom">
